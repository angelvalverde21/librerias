...
var Facebook_correctLogin	= function () {
	...
	FB.api('/me', function(response) {
		...
		console.log(facebookUser.first_name);
		console.log(facebookUser.last_name);
		console.log(facebookUser.link);
		console.log(facebookUser.gender);
		console.log(facebookUser.locale);
		console.log(facebookUser.timezone);
		console.log(facebookUser.updated_time);
		console.log(facebookUser.verified);
	})
};
